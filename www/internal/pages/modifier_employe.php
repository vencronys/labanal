...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE employes SET nom=?, prenom=?, cin=?, date_naissance=?, sexe=?, adresse=?, Téléphone=?, salaire=?, date_embauche=? WHERE id=? AND id_medecin=?");
    $stmt->execute([$nom, $prenom, $cin, $date_naissance, $sexe, $adresse, $telephone, $salaire, $date_embauche, $id, $_SESSION['medecin_id']]);
